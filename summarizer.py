...
# def get_summary(text, tone="formal", length="medium"):
#     """
#     Get a summary of the given text using DeepSeek model via OpenRouter.

#     Args:
#         text (str): Text to summarize.
#         tone (str): Tone of the summary (not strictly used by the model).
#         length (str): Desired length of summary (not strictly used by the model).

#     Returns:
#         str: The summarized output.
#     """
#     try:
#         prompt = f"Summarize this text in a {tone} tone and {length} length:\n\n{text}"
